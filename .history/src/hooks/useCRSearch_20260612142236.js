...
export function useCRSearch() {
    const [crs] = useState([
        ...
        { id: 2, crCode: "8071", crName: "CR Blumenauuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuua", branchName: "SENAI Blumenau", responsibleUserName: "Viviane Ciez", sector: "Ensino Médio" },
