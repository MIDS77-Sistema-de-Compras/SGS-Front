    ...
    return (
        <div className={`flex h-screen ${montserrat.className}`}>
            ...
            <div className="flex-1 flex item-center justify-center bg-gray-100">
                <form onSubmit={handleLogin} className="w-[400px] bg-blue-900 p-10 rounded-3xl flex flex-col gap-5 shadow-2xl">

                    <h2 className="text-white text-5xl font-bold text-center">SGS</h2>
