...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen w-full bg-gradient-to-br from-[#002663] via-[#003C97] to-[#4B84F4] flex items-center justify-between px-16 lg:px-28 relative py-12">
            ...
            {/* COLUNA DA ESQUERDA: Agrupa o texto e os logos no rodapé */}
            <div className="flex flex-col justify-between h-[75vh] max-w-[600px]">

                {/* Bloco de Textos com pesos de fonte diferentes */}
                ...
                {/* Bloco de Logos (Agora fixado corretamente embaixo do texto) */}
            ...
            <form onSubmit={handleLogin} className="w-[440px] bg-[#0A2E6B] rounded-[24px] px-10 py-12 flex flex-col gap-6 shadow-2xl border border-white/5">
                ...
                {/* Links de Políticas no Rodapé do Card */}
