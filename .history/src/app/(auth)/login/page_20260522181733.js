...
export default function LoginPage() {
    ...
    return (
        <main className={`min-h-screen w-full bg-gradient-to-r from-[#003C97] to-[#4B84F4] flex items-center justify-between px-24`}>
            ...
            <Image src="/images/logos/facebookLogo.png" alt="logoFaceBook" width={25} height={25} />
            <Image src="/images/logos/facebookLogo.png" alt="logoFaceBook" width={25} height={25} />
            <Image src="/images/logos/facebookLogo.png" alt="logoFaceBook" width={25} height={25} />
            <Image src="/images/logos/facebookLogo.png" alt="logoFaceBook" width={10} height={25} />
