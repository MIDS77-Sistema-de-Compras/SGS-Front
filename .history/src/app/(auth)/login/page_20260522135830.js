...
export default function LoginPage() {
    ...
    return (
        <main className={`min-h-screen w-full bg-gradient-to-r from-[#003C97] to-[#4B84F4] flex items-center justify-between px-24 ${montserrat.className}`}>
            ...
            <form onSubmit={handleLogin} className="w-[520px] bg-[#00337C] rounded-[40px] px-14 py-16 flex flex-col gap-8 shadow-2xl">

            <h2 className="text-white text-6xl font-bold text-center mb-2">
                SGS
            </h2>

            <p className="text-white text-lg text">Insira suas credenciais para acessar o sistema</p>
            <div>
                <input
                    type="text"
