...
export const selectVariantStyles = {
  form: 'h-auto py-2.5 text-sm bg-white border border-gray-200 shadow-sm focus:border-[#103D85] focus:ring-0.5 focus:ring-[#103D85] text-gray-800 dark:bg-[#303746] dark:border-white/15 dark:text-[#E2E2EA] dark:focus:border-[#1A4A9E] dark:focus:ring-[#1A4A9E]',
