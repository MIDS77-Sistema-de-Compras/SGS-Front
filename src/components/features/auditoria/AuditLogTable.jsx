            ...
            <div className="hidden lg:block flex-1 min-h-0 w-full overflow-auto pr-2 pb-2">
                <table className="w-full text-left border-collapse table-fixed min-w-[900px]">
                    <thead className="sticky top-0 z-10">
                        <tr className="text-[12px] min-[1350px]:text-sm font-semibold text-gray-700 dark:text-[#E2E2EA] bg-[#F8FAFC] dark:bg-[#303746] shadow-[0_1px_0_0_rgba(243,244,246,1)] dark:shadow-[0_1px_0_0_#303746]">
                            {columns.map((col) => (
                                <th key={col.label} className={`py-3 px-2 min-[1350px]:px-4 font-medium whitespace-nowrap ${col.width}`}>
                                    {col.sortable ? (
                                        <div
