            ...
            <div className="flex flex-col flex-1">
              {logs.map((log, index) => (
                    <div
                        ...
                        className={`grid grid-cols-[60px_1fr_110px_100px_1fr_110px_110px] gap-2 px-6 py-3 items-center text-[13px] border-b border-gray-100 cursor-pointer hover:bg-gray-100 transition-colors ${
