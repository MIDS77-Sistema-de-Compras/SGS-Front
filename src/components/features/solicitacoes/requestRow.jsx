...
export default function SolicitacaoRow({ item, onClick }) {
    ...
    return (
        <div
            onClick={onClick}
            className="py-5 border-b border-gray-100 dark:border-white/10 cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5 transition"
        >
            <div className="grid grid-cols-3 flex-1 items-center gap-20 px-6">
                <span className="font-bold text-[#333333] dark:text-[#E2E2EA]">
                    {item.codigo}
