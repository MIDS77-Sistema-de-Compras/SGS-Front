    ...
    return (
        <div className="h-full bg-white dark:bg-[#303746] rounded-xl border border-gray-100 dark:border-white/10 shadow-sm p-4 flex flex-col gap-3.5 w-full">
            <div className="flex justify-between items-start gap-3">
                <span className="font-bold text-lg text-gray-800 dark:text-[#E2E2EA] tracking-wide shrink-0">
                    {cr.crCode}
                </span>
                <span className="text-right font-bold text-[12px] text-black dark:text-[#E2E2EA] pt-1 leading-tight">
                    {cr.sector || cr.crName}
                </span>
            </div>
