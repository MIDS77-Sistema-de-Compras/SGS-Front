  ...
  return (
    <section className="w-full overflow-hidden rounded-2xl border border-[#A3A3A3] bg-white">
      ...
      <div className="px-5 py-2">
        <div className="pr-4">
          <div className="grid grid-cols-[1.2fr_1fr_1.7fr_260px_72px] items-center rounded-2xl bg-[#F0F0F0] px-6 py-3 text-center text-sm font-semibold text-[#103D85]">
        ...
        <div className="max-h-[360px] overflow-y-auto pr-2">
          {requests.map((request) => (
            <div
              key={request.id}
              className="grid min-h-16 grid-cols-[1.2fr_1fr_1.7fr_260px_72px] items-center border-b border-[#A3A3A3] px-6 text-center text-xs text-[#111827]"
            >
