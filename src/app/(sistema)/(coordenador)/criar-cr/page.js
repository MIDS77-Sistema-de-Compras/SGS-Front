...
export default function CadastrarCR() {
    return (
        <div className="scroll-native flex flex-col xl:flex-row gap-6 xl:gap-10 flex-1 min-h-0 overflow-y-auto xl:overflow-visible pr-2 xl:pr-0 lg:pb-60 xl:pb-0">
